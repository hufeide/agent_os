...
task_description = {
    "name": "经典爱情诗歌研究",
    "description": "搜索并整理经典爱情诗歌、名句、意象和表达方式，为创作提供灵感"
}
        ...
        for i, task in enumerate(detailed_status['tasks'], 1):
            ...
            if task.get('result'):
                ...
                if result.get('key_findings'):
                    ...
                    print(f"      关键发现数量: {len(key_findings)}")
